...
def test_comparison_csv_with_synthesis():
    comp = _comparison()
    comp.synthesis = "Two different approaches to attention."
    text = to_csv(comp)
    assert "对比小结" in text
    assert "Two different approaches to attention." in text

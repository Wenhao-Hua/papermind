...
def test_comparison_csv_with_synthesis():
    comp = _comparison()
    comp.synthesis = "These two papers differ significantly."
    text = to_csv(comp)
    assert "对比小结" in text
    assert "These two papers differ significantly." in text

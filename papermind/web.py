...
def _hero() -> str:
    ...
    return (
        ...
        "粘贴任意论文链接（arXiv、论文页面或 PDF），或上传 PDF 即可开始。</p>"
...
def _analyze_form(live: bool, error: str = "") -> str:
    ...
    return (
        ...
        "<label>论文 <span class='hint'>URL（arXiv、论文页面或 PDF 链接）</span></label>"
        "<input name='source' placeholder='arXiv / bioRxiv / OpenReview / 论文页面 / PDF 链接' autofocus>"

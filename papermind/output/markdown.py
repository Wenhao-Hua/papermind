...
def _reading_minutes(report: Report) -> int:
    """Estimate reading time in minutes based on report text content (~200 wpm for academic text)."""
    texts = []
    ...
    if report.reproduction:
        ...
        texts += [r.requirements or "", r.recommended_hardware or ""] + list(r.gotchas)

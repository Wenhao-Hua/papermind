...
from papermind.output.schema import Connection, Reproduction, Report, Source, TechnicalPoint, estimate_reading_minutes
...
def _meta(report: Report) -> str:
    ...
    bits.append(f"~{estimate_reading_minutes(report)} min read")
    return " &nbsp;•&nbsp; ".join(bits)
